...
class DetectColorMarker:
    ...
    def __init__(self, params):
        ...
        avg_color_right_rgb, avg_color_left_rgb = self.calculate_avg_rgb()
        print('color_right rgb: ', avg_color_right_rgb)
        print('color_left rgb: ', avg_color_left_rgb)
        np.save('~/adapcomanip_ws/src/comanip_htn/avg_color_right_rgb', avg_color_right_rgb)
        np.save('~/adapcomanip_ws/src/comanip_htn/avg_color_left_rgb', avg_color_left_rgb)
...
def main():
    rospy.init_node('CalibrateColorMarker')
